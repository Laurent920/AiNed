...
def compute_full_bpp(params, all_neuron_states, next_grad, split_rank):
    '''
...
@partial(jax.jit, static_argnames=['params', 'split_rank'])
def back_prop(params, all_neuron_states, next_grad, split_rank):
    weight_grad, weight_res  = jax.vmap(compute_full_bpp, in_axes=(None, 0, 0, None))(params, all_neuron_states, next_grad, split_rank) # Shape: (B, 784, 128)
